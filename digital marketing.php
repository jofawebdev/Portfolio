...
<html lang="en">
    ...
    <body>
                    ...
                    <ul class="navbar-nav me-auto">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a class="dropdown-item active" href="digital marketing">Digital Marketing</a></li>
        ...
        <header class="position-relative w-100" id="home">
            <img class="img-fluid w-100" src="images/digital-marketing-is-important-to-grow-businesses.jpg" alt="">
        </header>
