...
<html lang="en">
    <head>
        <title>Blog - Website Development | SEO | Digital Marketing</title>
    ...
    <body>
            ...
            <div class="row d-flex align-items-stretch">
                <div class="col-sm-12 col-md-6 col-lg-4 p-3 d-flex">
                    <div class="card flex-fill">
                        <img class="card-img-top img-fluid" src="images/pin100.jpg" alt="">
        ...
        <div class="container my-2 py-3">
            <ul class="pagination justify-content-center">
                ...
                <li class="page-item active"><a class="page-link" href="Blog">5</a></li>
