...
<html lang="en">
    <head>
        <title>Portfolio - Website Development | SEO | Digital Marketing</title>
                ...
                <div class="row g-5 align-items-center">
                    ...
                    <div class="col-lg-6">
                        <div class="d-flex flex-column gap-4">
                            ...
                            <a href="#projects" class="btn btn-outline-dark btn-lg mt-3 align-self-start">
                                View Case Studies <i class="bi bi-arrow-down"></i>
                            </a>
                        </div>
                    </div>
                </div>
